<template>
  <div v-if="isLoggedIn" class="container">
    ...
    <div class="form-container">
      <div>
        <h1 v-if="selectedAccount && selectedAccount.balance !== null" class="text-center text-muted">
      ...
      <div v-if="selectedAccount && selectedAccount.balance !== null" class="input-group mb-3">
      ...
      <form v-on:submit.prevent="login" ref="depoform">
        <div v-if="selectedAccount && selectedAccount.balance !== null" class="form-hider">
